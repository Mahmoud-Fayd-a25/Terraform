# Elastic IP (EIP) resource to provide a static public IP address to the instance.
# Security group rule to allow SSH traffic (port 22) for administration purposes.
# Configuration to associate the Elastic IP with the EC2 instance.
